...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/favicon.png" alt="SistemaVentas" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Sistema de Ventas</b><br>Ecuador, Los Rios<br>Telefono:(+51)999999999<br>Email: 
                    sistemadeventas@gmail.com
                </p>
            </div>
            <div id="fact">
